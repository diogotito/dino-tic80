...
-- COPY OF DINOCUBE                --
do
	-- with readonly access to globals
	setmetatable(CUBE, {__index=_ENV})
	local _ENV = CUBE
-- - - - - - - - - - - - - - - - - --
...
--]]
function dump_tbl(t, i) -- DINOCUBE
	i = i or 0
...
z=100
rX,rY,rZ = 0,0,0
vrX,vrY,vrZ = 0.022, 0.055, 0.038

function TIC() -- DINOCUBE
	-- move it
	x, y = x+vx, y+vy
	if x<26  then vx= 1 vrY=-vrY end
...
-- 001:2f2a35443d386256539a5d40a981433b42626f7777989da0c2b8a9d9dbba000404ffffff000000000000000000000000
-- </PALETTE>
